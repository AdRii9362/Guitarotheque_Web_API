...
//    Nom = "TestBLL",
//    Prenom = "TestBLL",
//    DateNaiss = new DateTime(1999, 10, 20)
//};

//List<int> idGuitares = new List<int> { 6,9 }; // Remplacez cette liste avec les ID de vos guitares
//guitaristeService.Update(guitaristeModel, 36, idGuitares);
